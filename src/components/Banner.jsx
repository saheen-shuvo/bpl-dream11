...
const Banner = () => {
    return (
        <div className='mx-20 mt-9 relative'>
            ...
            <h3 className=' text-4xl font-bold text-white'>Assemble Your Ultimate Dream 11 Cricket Team</h3>
            <h5 className='text-2xl font-normal text-gray-400 text-center pt-4'>Beyond Boundaries Beyond Limits</h5>
